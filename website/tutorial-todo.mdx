...
import { StoreProvider } from '@suzumiyaaoba/scope-flux-react';
...
- `StoreProvider` makes that scope available to all `@suzumiyaaoba/scope-flux-react` hooks below it.
...
import {
  ...
  useFlushBuffered,
  useUnit,
} from '@suzumiyaaoba/scope-flux-react';
...
```ts
import { hydrate, serialize } from '@suzumiyaaoba/scope-flux-serializer';
...
cd scope-flux-todo
npm install
npm install @suzumiyaaoba/scope-flux-core @suzumiyaaoba/scope-flux-react @suzumiyaaoba/scope-flux-serializer @suzumiyaaoba/scope-flux-inspect
```
