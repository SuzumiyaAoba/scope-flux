...
const coreTypeItems = [
  ...
  { text: 'RunOptions', link: '/api/core/types/run-options' },
  { text: 'EffectPolicy', link: '/api/core/types/effect-policy' },
  { text: 'EffectStatus<R>', link: '/api/core/types/effect-status' },
  ...
  builderConfig: {
    resolve: {
      alias: {
        ...
        '@suzumiyaaoba/scope-flux-serializer': resolve(__dirname, '../packages/serializer/src/index.ts'),
        '@suzumiyaaoba/scope-flux-inspect': resolve(__dirname, '../packages/inspect/src/index.ts'),
      },
    },
  },
  plugins: [
